...
HD_PWD='/nfs/home/a/ac_pate/COEN313/mylab2/code/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_of_minterms.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_of_minterms.tcl -notrace
