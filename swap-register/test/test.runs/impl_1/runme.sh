...
HD_PWD='/nfs/home/a/ac_pate/COEN313/Basic-FPGA-Projects/test/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_swap_load.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_swap_load.tcl -notrace
