...
HD_PWD='/nfs/home/a/ac_pate/COEN313/Basic-FPGA-Projects/test/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_swap_load.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_swap_load.tcl
