...
HD_PWD='/nfs/home/a/ac_pate/COEN313/Basic-FPGA-Projects/occupancy-tracker/occupancy-tracker/occupancy-tracker.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log occupancy_tracker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source occupancy_tracker.tcl -notrace
