...
HD_PWD='/nfs/home/a/ac_pate/COEN313/Basic-FPGA-Projects/occupancy-tracker/occupancy-tracker/occupancy-tracker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log occupancy_tracker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source occupancy_tracker.tcl
